...
######### 키워드를 중심으로 파인콘에서 뽑은 문서를 유사도 조정을 실시함. ##################
          ...
          for doc in docs:
              ...
              for cluster in clusters:
                  ...
                  if similarity >= threshold:
                      ...
                      if (-doc[0]+cluster[0][0]<0.6 or cluster_title==title and cluster[0][3]!=doc[2]and compare_date<60):
                        cluster.append(doc)
